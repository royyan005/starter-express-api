...
module.exports = {
    getAll: async (req, res, next) => {
        try {
            ...
            let sub_sub_matkulCount = await sub_sub_matkuls.findAndCountAll({
                where: {
                    [Op.or]: [{
                            deskripsi: {
                                [Op.like]: `%${search}%`
            ...
            let count = sub_sub_matkulCount.count;
            let pagination = {}
            pagination.totalRows = count;
            pagination.totalPages = Math.ceil(count / limit);
            pagination.thisPageRows = sub_sub_matkulCount.rows.length;
    ...
    delete: async (req, res, next) => {
        ...
        try {
            ...
            await klasifikasi_sub_sub_matkuls.destroy({
                where: {
                    sub_sub_matkul_id: sub_sub_matkul.id
                }
            })
